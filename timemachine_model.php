...
class Timemachine_model extends \Model
{
    ...
    public function process($data)
    {
        ...
        foreach (explode("\n", $data) as $line) {
            ...
            if (array_key_exists("Destinations", $plist) && is_array($plist["Destinations"]) && array_key_exists("legacy_output", $plist) && ($plist["legacy_output"] == "Mac OS X 10.12+ not supported with legacy Time Machine log output" || $plist["legacy_output"] == "macOS 10.12+ not supported with legacy Time Machine log output")) {
